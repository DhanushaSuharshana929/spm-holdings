                                        ...
                                        <div class="single-product-item">
                                            <div class="img-holder">
                                                ...
                                                <div class="overlay-content">
                                                    <a href="contact.php">Contact Now<span class="flaticon-right-arrow"></span></a>
                                                </div>
                                            </div>
                                            <div class="title-holder">
                                                <h4><a href="contact.php">Women Latest Trend</a></h4>
                                                <div class="bottom">
                                                    <div class="rating-box">
                                                        <p>Easily apply to multiple jobs with one click! Quick Apply shows....</p>
                                                    </div>
