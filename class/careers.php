...
class careers {
    ...
    public function __construct($id) {
        ...
        if ($id) {
            ...
            $query = "SELECT `id`,`title`,`image_name`,`short_description`,`description`,`queue` FROM `careers` WHERE `id`=" . $id;
    ...
    public function create() {
        ...
        $query = "INSERT INTO `careers` (`title`,`image_name`,`short_description`,`description`,`queue`) VALUES  ('"
                . $this->title . "','"
                . $this->image_name . "', '"
    ...
    public function all() {
        ...
        $query = "SELECT * FROM `careers` ORDER BY queue ASC";
